...
public class AdministratorProductsStorage {
    ...
    public static void mainStorage() {
        ...
        ProductsByCategory pc = admin.getCategory("Молоко");
    ...
    private ProductsByCategory getCategory(String str){
        return productsByCategories.stream().filter(p->str.equals(p.getCategory())).collect(Collectors.toList()).get(0);
    }
